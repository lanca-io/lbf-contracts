...
library Storage {
    ...
    struct ParentPool {
        ...
        uint128 lurScoreSensitivity; // has the scale i_liquidityTokenDecimals
        uint128 lurScoreWeight; // has the scale i_liquidityTokenDecimals
        uint128 ndrScoreWeight; // has the scale i_liquidityTokenDecimals
